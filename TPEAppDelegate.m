...
#import "TPEAppDelegate.h"
#import "TPEMathematicsViewController.h"
@implementation TPEAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    TPEMathematicsViewController *math = [[TPEMathematicsViewController alloc] init];
    
    UITabBarController *mainController = [[UITabBarController alloc] init];
    mainController.viewControllers = @[math];
